      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8 sm:pt-14 sm:pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3">
              <li><Link href="/auth/become-seller-signup" className="text-sm font-medium text-slate-200 hover:text-white transition-colors">Sell on ebakx</Link></li>
              <li><Link href="/auth" className="text-sm font-medium text-slate-200 hover:text-white transition-colors">Buy on Ebakx</Link></li>
        ...
        <div className="mt-10 border-t border-slate-600 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="inline-flex items-center gap-2 w-fit rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-800 ">
            <Image
