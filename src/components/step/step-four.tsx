...
export default function StepFour({ data, onChange, onNext, onPrevious }: StepFourProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-8">Setup how you will receive your Payments</h1>

      <div className="bg-[#0000000F] rounded-lg p-8 space-y-6">
        {/* Business Account Holder's Name */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">Business Account Holder&lsquo;s Name</label>
          <input
            type="text"
        ...
        {/* Account Number/IBAN */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">Account Number/IBAN</label>
          <input
            type="text"
        ...
        {/* SWIFT CODE/BIC */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">SWIFT CODE/BIC / Routing Number</label>
          <input
            type="text"
        ...
        {/* Stripe ID (Optional) */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">Stripe ID (Optional)</label>
          <input
            type="text"
        ...
        {/* TIN Number (Optional) */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">TIN Number (Optional)</label>
          <input
            type="text"
